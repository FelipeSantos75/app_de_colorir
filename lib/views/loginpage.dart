...
class _LoginPageState extends State<LoginPage> {
  ...
  // Configure o Google Sign-In com seu Client ID
  final GoogleSignIn _googleSignIn = GoogleSignIn(
    // Para Web, adicione o clientId aqui:
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      print('✅ Google User obtido: ${googleUser.email}');

      // Obtain auth details from request
      final GoogleSignInAuthentication googleAuth =
          await googleUser.authentication;
      print('✅ Autenticação Google obtida');
      ...
      print('✅ Login Firebase concluído: ${userCredential.user?.email}');
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Title
                    const Title(title: 'Bem-vindo ao Vamos Colorir'),
                    const SizedBox(height: 32),
                    // Login form
                    _formSignin(),
                  ],
